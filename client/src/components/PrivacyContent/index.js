...
const PrivacyContent = () => {
  ...
  return (
    <div className={classes.body}>
      <>
        <h2>Soy Tofu Privacy Policy</h2>

        <h3>Introduction</h3>
        <p>This Privacy Policy outlines Soy Tofu (" we ", " our " or " the Company ") practices with respect to information collected from users who access our website at soytofucalifornia.com (" Site "), or otherwise share personal information with us (collectively: " Users "). </p>
        <h3>Grounds for data collection </h3>
        ...
        <ul>
          <li>Device Information: We collect Personal Information from your device. Such information includes geolocation data, IP address, unique identifiers (e.g. MAC address and UUID) and other information which relates to your activity through the Site</li>
          <li>Registration information: When you register to our Site you will be asked to provide us certain details such as: full name; e-mail or physical address, and other information.</li>
        </ul>

        <h3>How do we receive information about you?</h3>
        <p>We receive your Personal Information from various sources:</p>
        <ul>
          <li>When you voluntarily provide us your personal details in order to register on our Site;</li>
        ...
        <ul>
          <li>Communicating with you – sending you notices regarding our services, providing you with technical information and responding to any customer service issue you may have;</li>
...
Address:  4961 LA PALMA AVE,LA PALMA, CA,90623
